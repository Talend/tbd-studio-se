...
public class DriverITCDH513 {
    ...
    public static void main(String[] args) {
        ...
        EndPointProxy endPointProxy1 = new EndPointProxy(myCustomEntity.getIdentity(), SourceType.SDK, EntityType.OPERATION_EXECUTION);
        EndPointProxy endPointProxy2 = new EndPointProxy(myCustomEntity2.getIdentity(), SourceType.SDK, EntityType.OPERATION_EXECUTION);
