...
//
// ============================================================================
package org.talend.hadoop.distribution.emr540.modulegroup.node.pigoutput;
...
public class EMR540PigOutputNodeModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        ...
        hs.add(new DistributionModuleGroup(EMR540PigModuleGroup.PIG_PARQUET_GROUP_NAME, false, condition));
        hs.add(new DistributionModuleGroup(EMR540PigModuleGroup.PIG_S3_GROUP_NAME, false, s3condition));
        return hs;
    }
