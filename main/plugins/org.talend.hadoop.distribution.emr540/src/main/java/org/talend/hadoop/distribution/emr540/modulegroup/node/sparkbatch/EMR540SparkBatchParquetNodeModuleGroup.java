...
public class EMR540SparkBatchParquetNodeModuleGroup {

    public static final String SPARK_PARQUET_GROUP_NAME = "SPARK-PARQUET-LIB-MRREQUIRED-EMR_5_4_0_LATEST"; //$NON-NLS-1$
