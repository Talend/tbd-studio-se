...
public class EMR540HiveModuleGroup {

    public static final String HIVE_HBASE_MODULE_GROUP = "HIVE-HBASE-LIB-EMR_5_4_0_LATEST"; //$NON-NLS-1$

    public static final String MODULE_GROUP_NAME = "HIVE-LIB-EMR_5_4_0_LATEST"; //$NON-NLS-1$
