...
public interface SqoopComponent extends MRComponent {
    ...
    /**
     * @return true if the distribution with the bug https://issues.apache.org/jira/browse/SQOOP-2995. 
     * Have to set a init value to the new map type key "customtool.options.jsonmap". 
