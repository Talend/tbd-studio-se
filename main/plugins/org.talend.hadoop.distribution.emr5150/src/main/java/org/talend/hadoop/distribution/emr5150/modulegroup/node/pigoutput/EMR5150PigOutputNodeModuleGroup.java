...
public class EMR5150PigOutputNodeModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        ...
        hs.add(new DistributionModuleGroup(EMR5150PigModuleGroup.PIG_PARQUET_GROUP_NAME, false, condition));
        hs.add(new DistributionModuleGroup(EMR5150PigModuleGroup.PIG_S3_GROUP_NAME, false, s3condition));
        return hs;
    }
