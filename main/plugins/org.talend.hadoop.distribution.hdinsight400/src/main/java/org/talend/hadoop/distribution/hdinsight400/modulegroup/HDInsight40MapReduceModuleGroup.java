...
public class HDInsight40MapReduceModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(HDInsight40Constant.HDINSIGHT400COMMON_MODULE_GROUP.getModuleName(), true, condition));
        hs.add(new DistributionModuleGroup(HDInsight40Constant.SPARK23_MAPREDUCE_MODULE_GROUP.getModuleName(), true, conditionSpark2_3));
        hs.add(new DistributionModuleGroup(HDInsight40Constant.SPARK24_MAPREDUCE_MODULE_GROUP.getModuleName(), true, conditionSpark2_4));
        hs.add(new DistributionModuleGroup(HDInsight40Constant.SPARK23_MAPREDUCE_PARQUET_MODULE_GROUP.getModuleName(), true, conditionSpark2_3));
        hs.add(new DistributionModuleGroup(HDInsight40Constant.SPARK24_MAPREDUCE_PARQUET_MODULE_GROUP.getModuleName(), true, conditionSpark2_4));
        return hs;
    }
}
