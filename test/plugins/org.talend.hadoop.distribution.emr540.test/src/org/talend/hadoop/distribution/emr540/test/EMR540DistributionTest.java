...
//
// ============================================================================
package org.talend.hadoop.distribution.emr540.test;
...
/**
 * Test class for the {@link EMR540Distribution} distribution.
 *
 */
public class EMR540DistributionTest {
    ...
    public void testEMR500Distribution() throws Exception {
        HadoopComponent distribution = new EMR540Distribution();
        assertNotNull(distribution.getDistributionName());
        assertNotNull(distribution.getVersionName(null));
        assertTrue(distribution.doSupportS3());
        assertEquals(EMR540Distribution.DISTRIBUTION_NAME, distribution.getDistribution());
        assertEquals(EMR540Distribution.VERSION, distribution.getVersion());
