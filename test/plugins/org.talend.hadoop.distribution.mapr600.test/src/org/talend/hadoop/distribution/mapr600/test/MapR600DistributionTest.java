...
public class MapR600DistributionTest {
    ...
    public void testMapR600Distribution() throws Exception {
        ...
        AbstractDistribution mapr600Distrib = (MapR600Distribution) distribution;
        assertFalse(mapr600Distrib.doSupportWebHDFS());
        assertFalse(mapr600Distrib.doSupportADLS());
    }
